...
func init() {
	...
	tcpGenNums   = tcpCmd.Int("nums", 1, "数据生成组件的实例数")
	tcpWorkers   = tcpCmd.Int("workers", 1, "数据输出组件的实例数")
	...
	udpGenNum    = udpCmd.Int("nums", 1, "数据生成组件的实例数")
	udpWorker    = udpCmd.Int("workers", 1, "数据输出组件的实例数")
	...
	httpGenNum    = httpCmd.Int("nums", 1, "数据生成组件的实例数")
	httpWorker    = httpCmd.Int("workers", 1, "数据输出组件的实例数")
	...
	esGenNum    = esCmd.Int("nums", 1, "数据生成组件的实例数")
	esWorker    = esCmd.Int("workers", 1, "数据输出组件的实例数")
	...
	esShard     = esCmd.Int("shards", 3, "索引分片数")
	esReplica   = esCmd.Int("replicas", 0, "索引副本数")
	esFlushByte  = esCmd.Int("flushBytes", 1000000, "flush阈值(单位为字节)")
	...
	kafkaGenNum    = kafkaCmd.Int("nums", 1, "数据生成组件的实例数")
	kafkaWorker    = kafkaCmd.Int("workers", 1, "数据输出组件的实例数")
